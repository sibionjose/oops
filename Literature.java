...
String category; 
Literature (String pub, String boo){ super(pub, boo); 
} 
void display(){
...
Fiction(String pub, String boo){ super (pub, boo); 
} 
void display(){ 
System.out.println("Publisher: "+publisher);
 System.out.println("Book:"+book); 
...
int num1 = sc1.nextInt(); Fiction arr1[]=new Fiction[num1]; 
...
sc.close(); 
sc1.close();
System.out.println("\n********Informations of all the Literature Books************"); for(int i=0;i<num;i++){ 
j=i+1; 
System.out.println("\n"+j+")."); 
arr[i].display(); 
} 
